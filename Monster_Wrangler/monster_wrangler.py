...
class Game():
    ...
    def __init__(self, player, monster_group):
        ...
        #This list correlates to the monster_type attribute
        self.target_monster_images = [blue_image, green_image, purple_image, yellow_image]

        #Pick a random target monster and render it
...
class Monster(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        if self.rect.left <= 100 or self.rect.right >= WINDOW_WIDTH:
            self.dx = -1 * self.dx
